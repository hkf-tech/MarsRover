...
{
    [TestFixture]
    public class MoveLeftCommandHandlerTests
    {
        MoveLeftCommandHandler _sut;

        [SetUp]
        public void Setup()
        {
            _sut = new MoveLeftCommandHandler();
        }

        [Test]
        public async Task When_Direction_Is_North_Change_Direction_To_West()
        {
            var currentCoodinates = new Coordinates(new System.Drawing.Point(3, 3), Direction.North);
            var command = new MoveLeftCommand(currentCoodinates);
        ...
        [Test]
        public async Task When_Direction_Is_East_Change_Direction_To_North()
        {
        ...
        [Test]
        public async Task When_Direction_Is_South_Change_Direction_To_East()
        {
        ...
        [Test]
        public async Task When_Direction_Is_West_Change_Direction_To_South()
        {
        ...
        public async Task When_Moved_Left_Position_Doesnt_Change(Direction direction)
        {
